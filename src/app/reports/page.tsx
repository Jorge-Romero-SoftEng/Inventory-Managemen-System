        ...
        <div className="flex-1 overflow-auto p-4">
              ...
              {dailyReport && (
                <>
                  <div className="grid grid-cols-4 gap-3">
                    ...
                    <Card>
                      <CardHeader className="pb-1">
                        <CardTitle className="text-sm text-muted-foreground">Discount</CardTitle>
                      </CardHeader>
                      <CardContent>
          ...
          {activeTab === "balances" && balanceReport && (
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Total Outstanding: <span className="font-mono text-orange-400">{formatCurrency(Number(balanceReport.totalBalance))}</span></CardTitle>
                </CardHeader>
              </Card>
              <Card>
                <CardContent className="p-0">
                        ...
                        <TableRow key={c.id}>
                          ...
                          <TableCell>
                            <Badge variant={Number(c.balance) > Number(c.creditLimit) * 0.8 ? "destructive" : "secondary"}>
                              {Number(c.balance) > Number(c.creditLimit) * 0.8 ? "Near Limit" : "OK"}
                            </Badge>
                          </TableCell>
                        </TableRow>
                      ))}
